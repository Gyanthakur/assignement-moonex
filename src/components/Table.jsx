...
const Table = () => {
	return (
		<div className="py-20 bg-darkGray m-10 mt-0">
			<h2 className="text-left text-2xl font-bold ml-10">
				Why <span className="text-yellow">MoonEX?</span>
			</h2>
			<div className="mt-8 flex justify-center">
				<table className="border-collapse border border-gray-500 w-full ml-5 mr-5">
					<thead>
						<tr>
							<th className="border border-gray-500 px-4 py-2">Feature</th>
							<th className="border border-gray-500 text-center flex items-center justify-center px-4 py-2">
							...
							<th className="border border-gray-500 text-center px-4 py-2">
								<img
									...
									alt=""
									className="h-10 w-50 lg:ml-[30%] sm:ml-0 md:ml-0"
								/>
							</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td className="border border-gray-500 flex justify-center items-center px-4 py-5 lg:py-2">
